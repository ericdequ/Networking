...
public class server{
    public static void main(String[] args) throws IOException{
        ...
        if(str.equals("1")){
            ...
            Joke = "funny";
            byte[] fileBytes = Files.readAllBytes(Paths.get("Joke1.txt"));
        } else if (str.equals("2")){
            //System.out.print("joke Option Chose = 2");
            Joke = "Really funny";
            byte[] fileBytes = Files.readAllBytes(Paths.get("Joke2.txt"));
        } else if (str.equals("3")){
            //System.out.print("joke Option Chose = 3");
            Joke = "Really Really funny";
            byte[] fileBytes = Files.readAllBytes(Paths.get("Joke3.txt"));
        } else{
